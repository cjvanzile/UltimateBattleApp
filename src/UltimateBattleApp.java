...
public class UltimateBattleApp {
    public static void main(String [] args) {
        ...
        //create water object to synchronize between all threads
        Water drink = new Water();
        //create several contender objects for the race
        ...
        //Start the contender threads (start the race). These rules run concurrently
